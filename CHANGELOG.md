...
this project follows the design document (PLAN.md) sections.
...
- Question authoring: schema-facts discovery + four category generators
  ...
  validated executable gold, dedup, and mechanical split tagging.
...
### Historical
- QwerySmith 1.x (fine-tuning pipeline, paper, v1 harness) preserved
