# Legacy: QwerySmith 1.x (the fine-tuning project)

This directory contains the **completed 1.0/1.1 project** - the multi-source
...
**Do not run anything from here for the current work.** The live
