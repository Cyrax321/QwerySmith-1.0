> **Historical document — the README as it existed at the 1.0/1.1 review.**
> Claims below ('production-ready', '100% success rate', in-distribution-only
> numbers) are exactly what the review flagged; kept verbatim as provenance.
> See ../README.md for the current harness and ../PLAN.md §1.1 for the mapping.
